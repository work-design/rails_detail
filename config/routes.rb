Rails.application.routes.draw do
  ...
  scope :my, module: 'detail/my', as: :my, defaults: { business: 'detail', namespace: 'my' } do
  ...
  scope :admin, module: 'detail/admin', as: :admin, defaults: { business: 'detail', namespace: 'admin' } do
    resources :lists do
      resources :items
    end
